function [a, phi] = func_decompose_Rot_matrix(C)
% phi is in radians
...
C_new1 = func_create_Rot_matrix(a, phi);
C_new2 = func_create_Rot_matrix(a, -phi);
C_new3 = func_create_Rot_matrix(-a, phi);
C_new4 = func_create_Rot_matrix(-a, -phi);
