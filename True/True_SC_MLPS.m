classdef True_SC_MLPS
    %True_SC_MLPS Summary of this class goes here
    ...
    properties
        ...
        name                             % name = ‘MLPS’
        health                           % health : Health of ith MLPS
        temperature                      % temperature [deg C] : Temperature of MLPS
        instantaneous_power_consumption  % 
        instantaneous_power_consumed     % instantaneous_power_consumed [Watts] : Instantaneous power consumed by MLPS
        instantaneous_data_volume        % instantaneous_data_volume [kb] : Data volume of MLPS
    ...
    methods
        ...
        function obj = True_SC_MLPS(mission_true_time,sc_body_init_data)
            ...
            obj.health = 1;
            obj.temperature = 10;
            obj.instantaneous_power_consumption = sc_body_init_data.mlps_power_consumption;
            obj.instantaneous_power_consumed = 0;
            obj.instantaneous_data_volume = sc_body_init_data.mlps_data_volume;
            obj.instantaneous_data_generated = 0; % [kilo bits]
            obj.measurement_frequency = sc_body_init_data.mlps_measurement_frequency;
            ...
            obj.location = sc_body_init_data.mlps_location; % [m] : Location of sensor, in body frame B
            obj.orientation = sc_body_init_data.mlps_orientation; % [m] : Location of sensor, in body frame B
        ...
        function obj = func_get_mlps_measurement(obj, True_time)
