function func_plot_IBEAM_orbit_visualization(mission)
    ...
    for i_SC = 1:1:mission.num_SC
        ...
        plot(mission.true_time.store.time(1:kd), mission.desired_IBEAM_distance * ones(size(mission.true_time.store.time(1:kd))), ':', 'LineWidth', 2, 'Color', mission.storage.plot_parameters.color_array(i_SC), 'DisplayName', 'Desired Relative Distance')
    end
