...
classdef True_SC_Sun_Sensor < handle
    ...
    properties
        ...
        field_of_view % [deg] : Field of view (FOV) of the camera in deg (No measurement if Sun is outside this FOV)
    ...
    methods
        ...
        function obj = True_SC_Sun_Sensor(init_data, mission, i_SC, i_HW)
            ...
            obj.mode_true_SC_sun_sensor_selector = init_data.mode_true_SC_sun_sensor_selector; % [string]
            ...
            if (obj.flag_executive == 1) && (obj.health == 1)
                ...
                if (mission.true_time.time_attitude - obj.measurement_time) >= obj.measurement_wait_time
                    ...
                    switch obj.mode_true_SC_sun_sensor_selector
                        ...
                        case 'Truth'
                            obj = func_true_SC_sun_sensor_Truth(obj, mission, i_SC);

                        case 'Simple'
                            obj = func_true_SC_sun_sensor_Simple(obj, mission, i_SC);
