...
classdef True_SC_Chemical_Thruster < handle
    ...
    properties
        ...
        instantaneous_data_generated     %[kb] : Data generated during the current time step, in kilo bits
    ...
    methods
        ...
        function obj = True_SC_Chemical_Thruster(init_data, mission, i_SC, i_MT)
            ...
            obj.instantaneous_data_generated = init_data.instantaneous_data_generated_per_sample; % Kb
            ...
            obj.instantaneous_data_volume = obj.instantaneous_data_generated;  % Initialize to same value as data generated
